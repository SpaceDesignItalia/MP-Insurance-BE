...
class PolicyModel {
  ...
  static getRecentActivities(db) {
    return new Promise((resolve, reject) => {
      ...
      INNER JOIN public."client" USING("clientId")
      INNER JOIN public."vehicle" USING("vehicleId")
      ORDER BY policy."createdAt" DESC LIMIT 5`;
      db.query(policyQuery, (error, results) => {
        ...
        INNER JOIN public."client" USING("clientId")
        ORDER BY vehicle."createdAt" DESC LIMIT 5`;
        db.query(vehicleQuery, (error, results) => {
          ...
          const customerQuery = `SELECT "clientId", "firstName", "lastName", "email", "phoneNumber", "createdAt" FROM public."client" ORDER BY "createdAt" DESC LIMIT 5`;
